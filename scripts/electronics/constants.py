# The file contains constants used by other scripts
...
E48_list_full = sorted(list(set(E24_list) | set(E48_list)))
...
E96_list_full = sorted(list(set(E24_list) | set(E48_list) | set(E96_list)))
